    ...
    const partidos = lista.slice(0, 64).map(({m,dObj}) => {
      ...
      return {
        ...
        canalesInternacionales: [
          { pais: "🇭🇳 Honduras", canales: "Tigo Sports (300/301), Satelital 10/13, App Tigo Sports HN, Televicentro (abierta)" },
          { pais: "🇲🇽 México", canales: "Canal 5, Las Estrellas, Azteca 7, Azteca Uno, TUDN, ViX Premium" },
          { pais: "🇺🇸 USA", canales: "FOX, FS1 (inglés) · Telemundo, Universo, Peacock (español)" },
          { pais: "🇪🇸 España", canales: "La 1 (RTVE), RTVE Play, DAZN, Movistar Plus+" },
          { pais: "🇦🇷 Argentina", canales: "TV Pública, Telefe, TyC Sports, DSports, DGO" },
          { pais: "🇨🇴 Colombia", canales: "Caracol TV, RCN, Win Sports, DirecTV/DGO, Disney+" },
          { pais: "🇵🇪 Perú", canales: "América TV, América TVGO, DSports, DGO, Disney+ Premium" },
          { pais: "🇨🇱 Chile", canales: "Chilevisión (señal abierta), DSports, DGO" },
          { pais: "🇪🇨 Ecuador", canales: "Teleamazonas, DSports, DGO" },
          { pais: "🇧🇴 Bolivia", canales: "Canal Uno, Unitel, Tigo Sports" },
          { pais: "🇺🇾 Uruguay", canales: "Canal 5, Antel, VTV, DSports" },
          { pais: "🇵🇾 Paraguay", canales: "Telefuturo, Trece, Unicanal, GEN, Tigo Sports, DSports" },
          { pais: "🇨🇷 Costa Rica", canales: "Tigo Sports, TDMAX" },
          { pais: "🇬🇹 Guatemala", canales: "TV Azteca Guate, Albavisión (3 y 7), Tigo Sports" },
          { pais: "🇸🇻 El Salvador", canales: "Tigo Sports (3 y 300), App Tigo" },
          { pais: "🇵🇦 Panamá", canales: "RPC (Canal 4), TVN (Canal 2), TVMAX, Tigo Sports" },
          { pais: "🌍 Internacional", canales: "FIFA+ · DAZN (varios países) · VPN a señal de tu país" }
        ]
      };
    });
